...
import com.ricklovato.erudio.integrationtests.vo.pagedModels.PagedModelBook;
...
public class BookControllerXmlTest extends AbstractIntegrationTest{
	...
	public void testCreate() throws JsonProcessingException,JsonProcessingException {
		...
		assertEquals("Midnight Espresso",   book.getTitle());
	...
	public void testUpdate() throws JsonProcessingException,JsonProcessingException {
		...
		assertEquals("MorningStar",book.getAuthor());
		assertEquals("Midnight Espresso",book.getTitle());
		assertEquals(19.99,book.getPrice());
	}
